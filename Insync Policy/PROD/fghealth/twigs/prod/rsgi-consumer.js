const conf = {
    ...
    queues: {
        entry: { url: 'https://sqs.ap-south-1.amazonaws.com/920043513072/prod-rsgi-entry', region: 'ap-south-1' },
        client: { url: 'https://sqs.ap-south-1.amazonaws.com/920043513072/prod-rsgi-client' },
        fgenPolicy: { url: 'https://sqs.ap-south-1.amazonaws.com/920043513072/prod-rsgi-policy' },
        fgenRen: { url: 'https://sqs.ap-south-1.amazonaws.com/920043513072/prod-endt-rsgi-client' },
        insillion: { url: 'https://sqs.ap-south-1.amazonaws.com/920043513072/prod-rsgi-insillion' },
    },

    basePath: "/mnt/ebs1/fghealth/twigs",
    errorClass: "/mnt/ebs1/fghealth/twigs/error-class.js",
    retryOn: {
        ...
        services: [
            {
                ...
                target: {
                    ...
                    url: 'https://fgapi.royalsundaram.in/FirstGenV7/services/doIndividualPartyCreate',
                    errorPath: {
                            xnode: 'status',
                            mandatory: true
                    },                    
            ...
            },
            {
                ...
                target: {
                    method: 'POST',
                    headers: { 'Content-Type': "application/soap+xml; charset=UTF-8" },
                    url: 'https://fgapi.royalsundaram.in/FirstGenV7/services/doCorporatePartyCreate',
                    errorPath: {
                            xnode: 'status',
                            mandatory: true
                    },
