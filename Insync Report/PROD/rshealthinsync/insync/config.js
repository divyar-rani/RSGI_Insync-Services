const conf = {
    ...
    dbtype: 'mysql',
    server_id: 'is_rshealthinsync',
    db: {
        host: 'rs-prod-healthgmc-cluster.cluster-cq2cwczu14rw.ap-south-1.rds.amazonaws.com',
        port: 3306,
        database: 'is_rshealthinsync',
        user: 'admmin',
        password: 'WAYnsI6xGMbI8TTA',
    ...
    sqs: {
        url: "https://sqs.ap-south-1.amazonaws.com/920043513072/prod-iib-rsgi-insillion",
        region: 'ap-south-1',
        accessKeyId: '',
        secretAccessKey: '',
        iamRole: '',
